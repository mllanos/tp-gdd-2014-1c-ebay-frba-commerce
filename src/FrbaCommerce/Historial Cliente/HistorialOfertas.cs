...
namespace FrbaCommerce.Historial_Cliente
{
    public partial class HistorialOfertas : Form
    {
        ...
        public HistorialOfertas(HistorialCliente h, string cod_us)
        {
            InitializeComponent();
            hCliente = h;
            cod_usuario = cod_us;
        ...
        private void HistorialOfertas_FormClosing(object sender, FormClosingEventArgs e)
        {
            hCliente.Show();
        }
        ...
        private void HistorialOfertas_Load(object sender, EventArgs e)
        {
            ...
            {
                string sql = "EBAY.historial_cliente_ver_ofertas";
